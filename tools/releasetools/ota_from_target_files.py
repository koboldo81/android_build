...
#  if block_based:
  ...
  script.Print(" ")
  common.ZipWriteStr(output_zip, "magisk/magisk.zip", ""+input_zip.read("SYSTEM/addon.d/magisk.zip"))
  script.FlashMagisk()
  script.Print(" ")

#  if block_based:
  script.Print(" ")
  script.Print("Enabling Hal3 support...")
  script.Print(" ")
  common.ZipWriteStr(output_zip, "camera-hal-op3/camera-hal-op3.zip", ""+input_zip.read("SYSTEM/addon.d/camera-hal-op3.zip"))
  script.FlashHal3()
  script.Print(" ")
